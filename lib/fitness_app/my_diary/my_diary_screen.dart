...
class _MyDiaryScreenState extends State<MyDiaryScreen>
  ...
  void addAllListData() {
    ...
    listViews.add(
      TitleView(
        titleTxt: 'Your Recipes', // Changed
        subTxt: 'Browse', // Changed
    ...
    listViews.add(
      TitleView(
        titleTxt: "Today's Menu", // Changed
        subTxt: 'Plan Meal', // Changed
        animation: Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: widget.animationController!,
            curve:
    ...
    listViews.add(
      TitleView(
        titleTxt: 'Ingredients Stock', // Changed
        subTxt: 'Manage', // Changed
        animation: Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: widget.animationController!,
            curve:
    ...
    listViews.add(
      TitleView(
        titleTxt: 'Meal Prep', // Changed
        subTxt: 'Weekly Plan', // Changed
        animation: Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: widget.animationController!,
            curve:
